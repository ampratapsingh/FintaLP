...
A clean, responsive, and fast landing page for Finta, built with TypeScript and Vanilla CSS.
Designed to be lightweight, fully responsive, and easy to maintain without relying on heavy frameworks.
